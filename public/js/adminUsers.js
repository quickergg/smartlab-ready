...
document.addEventListener('DOMContentLoaded', () => {
  ...
  console.log('AdminUsers.js - Elements found:', {
  ...
  function toggleRoleFields() {
    ...
    if (!studentFields || !departmentSelect) return;
    if (roleName === "student") {
  ...
  // Submit new account (handled by addAccount.js)
  addAccountForm?.addEventListener('submit', (e) => {
    // Let addAccount.js handle; just close modal on success
    setTimeout(() => {
      hideAddAccountModal();
      loadUsers();
    }, 500);
