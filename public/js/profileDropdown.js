...
function loadUserProfile() {
  ...
  console.log('Loading user profile, gmail:', gmail);
  console.log('Profile email element:', profileEmail);
  
  if (profileEmail) {
    profileEmail.textContent = gmail || 'No email';
    console.log('Email set to:', profileEmail.textContent);
  } else {
  ...
  if (dropdownProfileEmail) {
    ...
    console.log('Email set to:', dropdownProfileEmail.textContent);
  } else {
    console.error('Dropdown profile email element not found!');
  }
}
